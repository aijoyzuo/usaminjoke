...
- **留言板**：匿名留言、選擇頭像、分頁顯示
- **創作者介紹**：介紹創作者與工作人員
- **後台管理系統**：新增 / 編輯 / 刪除梗圖組與圖片、管理分類與子分類、Excel 批次匯入、Supabase Auth 登入驗證、數據總覽儀表板（KPI 卡片 + 圖表統計）

---

## 後台預覽

後台需要登入才能操作，這裡先放兩張截圖給沒有帳號的人看看長怎樣：

| 圖組管理 | 數據總覽 |
|---|---|
| ![圖組管理後台](docs/screenshots/admin-manage.png) | ![數據總覽儀表板](docs/screenshots/admin-dashboard.png) |
